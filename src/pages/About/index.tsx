  ...
  return (
    <Layout title="About">
      ...
      <p class="mt-4 text-center text-xl">
        {RADIO_TITLE} is a YouTube radio stream managed by{" "}
        <StyledLink href="https://youtube.com/@jep0rix">James</StyledLink> for
        Minawans to enjoy Cerber's live karaokes on loop 24/7.
      </p>
